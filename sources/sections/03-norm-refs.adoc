...
While this Policy references UML, SQL and XML, and their technical specifications,
no requirements are derived from these documents. While this Policy
may be applied to extensions of those standards, conformance to them is the purview
of those standards, not this Policy.

The following are normative references for this Policy document in the sense that they
