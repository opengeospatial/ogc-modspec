...
. a <<ConformanceTestModule-definition,_conformance (test) module_>> is a reusable collection of related <<ConformanceClass-definition,_conformance test classes_>>.
