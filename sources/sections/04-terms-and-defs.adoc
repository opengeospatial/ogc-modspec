...
element that is used to group elements. 

NOTE: In the ModSpec, `package` is used in the context of a <<requirementspackage-definition,requirements package>> or a <<conformancepackage-definition,conformance test package>>.
