...
aggregate of all {{requirement}} with a single standrdization target that
...
collection of {{requirement class}}, 
{{recommendation}} and {{permission}} with a
...
{{requirement}}, {{recommendation}} or
{{conformance test class,}}. Included for completeness.
