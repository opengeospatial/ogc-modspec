...
NOTE: Example: The standardization target type for The OGC API – Features Standard are Web APIs. The standardization target type for the CDB Standard are datastores compliant with the requirements as stated in the CDB Standard. 
