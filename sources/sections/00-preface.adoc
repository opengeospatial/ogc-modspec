...
This Open Geospatial Consortium (OGC) member developed and approved document, referred to as the `ModSpec`, defines a model and related requirements 
...
The following OGC Members contributed and participated in developing the ModSpec Version 1.1.
...
* ModSpec Part providing requirements and recommendations for specifying requirements and conformance tests using RDFS, SHACL, and OWL; and
