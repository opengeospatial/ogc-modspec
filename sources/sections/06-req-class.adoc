...
For OGC stadnrds documents, these URIs SHALL be conformant with the OGC naming authority policies.#
====
...
From this document's view of requirements classes, one requirements
