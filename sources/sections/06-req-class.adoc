...
The following requirements specify the rules for the content and sructure of a modular standard. These requirements are also known as the `core` of the ModSpec.
