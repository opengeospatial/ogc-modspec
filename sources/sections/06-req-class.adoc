...
[[req-1]]
include::../requirements/core/REQ1_testable.adoc[]
...
[[req-2]]
include::../requirements/core/REQ2_assigned-uri.adoc[]
...
<<RequirementsClass-definition,requirements class>>). In this sense, the next requirement divides
