...
[width="90%",cols="2,6a"]
|===
^|*REQ000* |*/req/core/reqs-are-in-class*
...
[width="90%",cols="2,6a"]
|===
^|*REQ002* |*/req/core/all-components-assigned-unique-identifier*
...
<<RequirementsClass-definition>>). In this sense, the next requirement divides
...
^|A |Each requirement in a conformant standard _SHALL_ have a single standardization target type.
|===
