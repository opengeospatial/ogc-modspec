...
The following requirements specify the rules for the content and structure of a modular standard. 
These requirements are also known as the `core` of the ModSpec. All the requirements specified in the ModSpec core 
comprise the ModSpec Core Requirements Class. 

The following requirement states that every requirement in a standards document is associated with one or more requirements class(es).

[[req-0]]
[width="90%",cols="2,6a"]
|===
^|*Requirement 0* |*/req/core/reqs-are-in-class*
^|A |Each requirement in a standard _SHALL_ be associated with a requirements class.
|===
...
[width="90%",cols="2,6a"]
|===
^|*Requirement 1* |*/req/core/reqs-are-testable*
^|A |All parts of a requirement _SHALL_ be testable. 
^|B |Failure to pass any part of a requirement _SHALL_ be a failure to pass the associated conformance test.
|===
...
[width="90%",cols="2,6a"]
|===
^|*Requirement 2* |*/req/core/all-components-assigned-unique-identifier*
^|A |Each component of the standard, including requirements, requirements modules, requirements classes, 
conformance test, conformance modules, and conformance test classes _SHALL_ be assigned a unique identifer.
|===

The following recommendation encourages the consistent use of these unique identifiers in the standard 
...
These unique identifiers _SHOULD_ be used in any external documentation that reference
...
core text of the standard without violations of the ModSpec. This is
true if the requirements of the extension are not implicit in what is
included in the core.
|===

In this manner, the core requirements class and its associated content can be
...
structures for use in other components and/or structures throughout the standard.
|===
...
The core _MAY_ include the list of the names of all operations and operation parameters
...
[[req-3]]
include::../requirements/core/REQ_vocabulary.adoc[]
...
[[req-4]]
include::../requirements/core/REQ_single-standardization-target.adoc[]
...
[[req-5]]
include::../requirements/core/REQ_test-class-single-standardization-target.adoc[]
...
[[req-6]]
include::../requirements/core/REQ_requirements-grouped.adoc[]

[[req-7]]
include::../requirements/core/REQ_requirements-test-suite-structure.adoc[]
...
[[req-8]]
include::../requirements/core/REQ_requirements-correspondence.adoc[]
...
[[req-9]]
include::../requirements/core/REQ_no-optional-tests.adoc[]
...
[[req-10]]
include::../requirements/core/REQ_all-parameters-expressed.adoc[]

Conformance to a particular conformance class means exactly the same thing everywhere.

[[req-11]]
include::../requirements/core/REQ_conf-class-single-req-class.adoc[]
...
[[req-12]]
include::../requirements/core/REQ_con-class-dependencies.adoc[]
...
[[req-13]]
include::../requirements/core/REQ_imported-requirements-class.adoc[]
...
[[req-14]]
include::../requirements/core/REQ_all-classes-explicitly-named.adoc[]
...
[[req-15]]
include::../requirements/core/REQ_req-in-only-one-req-class.adoc[]
...
[[req-16]]
include::../requirements/core/REQ_co-dependent-requirements.adoc[]
...
[[req-17]]
include::../requirements/core/REQ_structure-requirements-classes.adoc[]
...
[[req-18]]
include::../requirements/core/REQ_requirements-and-dependencies.adoc[]
...
[[req-19]]
include::../requirements/core/REQ_profile-conformance.adoc[]

[[cls-6-5-4]]
==== There is a Defined Core

[[req-20]]
include::../requirements/core/REQ_core-requirements-separate.adoc[]

[[req-21]]
include::../requirements/core/REQ_requirements-and-dependencies-2.adoc[]

[[req-22]]
include::../requirements/core/REQ_requirements-and-dependencies-3.adoc[]
...
[[req-23]]
include::../requirements/core/REQ_core-and-extensions.adoc[]

[[req-24]]
include::../requirements/core/REQ_extensions-conformant-to-modspec.adoc[]
...
[[req-25]]
include::../requirements/core/REQ_restriction-of-extensions.adoc[]
...
[[req-26]]
include::../requirements/core/REQ_optional-requirements.adoc[]
...
[[req-27]]
include::../requirements/core/REQ_req-class-overlap-by-reference.adoc[]
