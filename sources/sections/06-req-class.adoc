...
[[rec-1]]
include::../recommendations/core/REC1_uri-external-use.adoc[]
...
[[req-4]]
include::../requirements/core/REQ4_single-standardization-target.adoc[]
...
is the same as the sequence of conformance tests and conformance classes is the conformance suite.
