...
This clause specifies the requirements and recommendations for the content and structure of a modular standard. 
...
These unique identifiers/labels _SHOULD_ be used in any external documentation that reference
...
[width="90%",cols="2,6a"]
|===
^|*Requirement 3* |*/req/core/vocabulary-and-parent-req-class*
^|A |Requirements on the use and interpretation of vocabulary _SHALL_ be in the requirements class where that use or interpretation is used.
|===
...
Importation of external vocabularies and schemas _MAY_ be in the core of a standard.
|===
