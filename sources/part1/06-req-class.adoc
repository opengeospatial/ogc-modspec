...
|REQ028 | /req/part1/uml/conformance-with-core 
|REQ029 | /req/part1/uml/object-model 
|REQ030 | /req/part1/uml/dependency-graph 
|REQ031 | /req/part1/uml/leaf-package
|REQ032 | /req/part1/uml/class-package
|REQ033 | /req/part1/uml/to-leaf
|REQ034 | /req/part1/uml/common-req-classes
|REQ035 | /req/part1/uml/source-target
|REQ036 | /req/part1/uml/leaf-package-dependency
|REQ037 | /req/part1/uml/two-way-dependency
|REQ038 | /req/part1/uml/segregate-into-leaf-packages
|===
...
[width="90%",cols="2,6"]
|===
|*REQ031* | */req/part1/uml/leaf-model* +
...
[width="90%",cols="2,6"]
|===
|*REQ034* | */req/part1/uml/common-req-classe* +
