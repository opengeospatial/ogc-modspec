...
This OGC member developed and approved document, referred to as the `ModSpec: Part 2`, defines an optional requirements class for the XML model extension the ModSpec core.
