...
This Open Geospatial Consortium (OGC) member developed and approved document, referred to as the `ModSpec: Part 2 - UML`, defines an optional ModSpec requirements class for UML.
