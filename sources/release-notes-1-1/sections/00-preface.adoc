...
This document provides the set of release notes for the OGC ModSpec: Core Standard (including Part1, and Part2), version 1.1[OGC 25-003]> and does not modify that Standard.
