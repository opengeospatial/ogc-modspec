...
This document provides the set of revision notes for the OGC ModSpec: Core Standard (including Part1, and Part2), version 1.1[OGC <document number>]> and does not modify that standard.
