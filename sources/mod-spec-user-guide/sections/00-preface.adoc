...
The OGC Modular Specification (ModSpec) is a framework for designing and structuring geospatial standards to enhance consistency, testability, and usability. 
It mandates a model-driven approach where standards are "broken" into reusable requirements classes — often called building blocks — to enable incremental 
