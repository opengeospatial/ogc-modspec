...
== Preface
This document is an informative user guide for undrstanding and implementing the requirements defined in the OGC ModSpec - A Standard for Designing and Writing Modular Standards
