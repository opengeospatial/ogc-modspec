...
conformance tests in a conformance class have the same standardization target. If the requirements class has one or more dependencies on another 
requirements class then . . 
