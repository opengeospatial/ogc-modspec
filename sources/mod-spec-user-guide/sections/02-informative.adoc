...
Below is an AsciiDoc example of an OGC requirements class table formatted for Metanorma publication. The example is a snippet from the OGC ModSpec core requirements class.
