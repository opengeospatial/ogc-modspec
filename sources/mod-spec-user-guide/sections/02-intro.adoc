...
In the OGC document template for a standard, the conformance suite specified in Annex A, Abstract Test Suite.

As with a requirement, every conformance test `SHALL` have a unique identifier and/or label. 
