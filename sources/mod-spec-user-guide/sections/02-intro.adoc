...
ensuring that everyone involved understands the problem, its significance, and why its important to solve.

The goal of the is to define a simple conceptual model that can support any and all requirements for tiled data stores and applications including extensions for visualization, portrayal, analytics, filtering, levels of detail, and so forth.
