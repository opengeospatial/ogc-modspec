...
class are associated requirements are in the same clause/subclause(s) in the standards document. This provides a logical modular 
...
|Dependency |ISO 19115: Geographic Information - Metadata
